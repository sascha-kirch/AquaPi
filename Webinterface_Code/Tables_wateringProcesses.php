...
<html lang="en-US">
   <head>
      ...
      <script type="text/javascript">
         ...
         <?php	
            $strSQL = "SELECT * FROM (SELECT WateringProcess.wateringProcessId, WateringProcess.timeStamp, Client.hostName, Client.IpAdress ";
            $strSQL = $strSQL . "FROM WateringProcess ";
            $strSQL = $strSQL . "INNER JOIN Client ON WateringProcess.clientMacAdressRefference = Client.macAdress ";
            $strSQL = $strSQL . "ORDER BY WateringProcess.wateringProcessId DESC LIMIT 10)var1 ";
            echo "var data = google.visualization.arrayToDataTable([";
            echo"['Watering Process ID','Time','Host Name','IP Adress'],";	
            		// Execute the query
            		if($result = mysqli_query($connection,$strSQL)){
            			while($row = mysqli_fetch_assoc($result)){
            				echo "[".$row['wateringProcessId'].",'".$row['timeStamp']."','".$row['hostName']."','".$row['IpAdress']."'],";
            			}				
   ...
   <body>
      ...
      <!-- Side navigation -->
      <div class="sidenav">
         <a href="Tables_sensorMeasurements.php">Sensor Measurements</a>
         <a href="Tables_clients.php">Clients</a>
         <a class="active" href="Tables_wateringProcesses.php">Watering Processes</a>
      </div>
