...
<html lang="en-US">
   ...
   <body>
      ...
      <!-- Side navigation -->
      <div class="sidenav">
         <a class="active" href="Help_controller.php">Controller</a>
         <a href="Help_schematic.php">Hardware Setup</a>
      </div>
      <div class="main-sidenav">
         <img class="help_img" src="controller.png" alt="Xbox360 Controller" style="width:80%">
      </div>
      <footer>
